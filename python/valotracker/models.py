"""
Pure-Python :class:`Player` model that wraps a :class:`valotracker._valotracker.PyPlayer`.
"""

from __future__ import annotations

from valotracker._valotracker import PyPlayer
...
class Player:
    ...
    ----------
    raw:
        The :class:`PyPlayer` instance returned by :meth:`valotracker.Client.get_players`.
    """
