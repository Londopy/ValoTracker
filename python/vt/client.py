"""
High-level Python wrapper around the compiled :class:`VtClient` extension type.
"""
...
from vt._vt import VtClient as _VtClient, PyPlayer


class Client:
    """Thin Python wrapper around the Rust-backed :class:`vt._vt.VtClient`.
