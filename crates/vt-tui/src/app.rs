...
pub struct App {
    ...
    // ── History view ──────────────────────────────────────────────────────────
    pub history: Option<Vec<vt_core::history::SavedMatch>>,
    pub history_selected: usize,

    // ── Encounter drill-down ──────────────────────────────────────────────────
    pub encounter_data: Option<Vec<vt_core::history::PlayerEncounter>>,
...
impl App {
    ...
    pub fn display_players(&self) -> Vec<&vt_core::ResolvedPlayer> {
        let Some(snap) = &self.snapshot else {
            return Vec::new();
        };
