...
impl Engine {
    ...
    pub async fn init() -> Result<Self, VtError> {
    ...
    pub async fn poll_game_state(&self) -> Result<GameState, VtError> {
    ...
    pub async fn build_snapshot(
        ...
        let (match_id, raw_players): (String, Vec<RawPlayer>) = match &game_state {
            ...
            _ => return Err(VtError::NotInMatch),
        };
