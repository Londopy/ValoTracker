...
use crate::{error::VtError, lockfile::Lockfile};
...
impl Auth {
    ...
    pub async fn from_lockfile(lockfile: &Lockfile, client: &Client) -> Result<Self, VtError> {
    ...
    async fn fetch_client_version() -> Result<String, VtError> {
